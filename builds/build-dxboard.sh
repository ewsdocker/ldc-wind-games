...
#
#	build-dxboard
#	  build the ldc-games:dxboard image and create a container for XBoard.
#
# =========================================================================
#
# @author Jay Wheeler.
...
echo "   ********************************************"
echo
docker stop ldc-games-dxboard-0.1.0 > /dev/null 2>&1
docker rm ldc-games-dxboard-0.1.0 > /dev/null 2>&1
...
echo "   ********************************************"
echo
docker rmi ewsdocker/ldc-games:dxboard-0.1.0 > /dev/null 2>&1

# ===========================================================================
#
#    ldc-games:dxboard-0.1.0
#
# ===========================================================================

echo "   ***************************************************"
echo "   ****"
echo "   **** building ewsdocker/ldc-games:dxboard-0.1.0 image "
echo "   ****"
echo "   ***************************************************"
echo
...
docker build \
  ...
  -t ewsdocker/ldc-games:dxboard-0.1.0  .
[[ $? -eq 0 ]] ||
 {
 	echo "build ewsdocker/ldc-games:dxboard-0.1.0 failed."
 	exit 1
 }

echo "   ***********************************************"
echo "   ****"
echo "   **** installing ldc-games-dxboard-0.1.0 container"
echo "   ****"
echo "   ***********************************************"
echo
...
docker run \
  ...
  \
  -it \
  --name=ldc-games-dxboard-0.1.0 \
ewsdocker/ldc-games:dxboard-0.1.0
[[ $? -eq 0 ]] ||
 {
 	echo "build container ldc-games-dxboard-0.1.0 failed."
 	exit 1
 }

echo "   ********************************************"
echo "   ****"
echo "   **** ldc-games:dxboard successfully installed."
echo "   ****"
echo "   ********************************************"
echo
